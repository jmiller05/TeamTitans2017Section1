...
public class Game extends Application
{
	...
	{
		Monster m0 = new Monster("Mon_00", "Toxic Wolfspider",
				...
				5, rand.nextInt(2) + 1);
		Monster m1 = new Monster("Mon_01", "Soul Serpent",
				"The soul stealing serpent will attack you to steal your soul with one of its bites.", 10,
				rand.nextInt(3) + 1);
		Monster m2 = new Monster("Mon_02", "Terror Tiger",
				"This ferocious tiger will terrorize you with razor sharp teeth and vibrant green eyes.", 15,
				rand.nextInt(3) + 1);
		Monster m3 = new Monster("Mon_03", "Tomb Phantom",
				"This tomb phantom haunts the tomb with his loud screeches and screams. This monster can make you deaf until next fight.",
				20, rand.nextInt(4) + 1);
		Monster m4 = new Monster("Mon_04", "Bloodthirsty Centaur",
				...
				25, rand.nextInt(4) + 1);
		Monster m5 = new Monster("Mon_05", "Disemboweled Mummy",
				...
				30, rand.nextInt(4) + 1);
		Monster m6 = new Monster("Mon_06", "The Insane Witch",
				...
				40, rand.nextInt(5) + 1);
		Monster m7 = new Monster("Mon_07", "Ballistic Beast",
	...
	public ArrayList<Room> populateRooms()
	{
		...
		Room.assignExits(new Exit(8), roomAL.get(7), "north", roomAL.get(8), "south");
